...
class WeatherDataPoint implements java.io.Serializable{//v. 2.2
    /**
	 * 
	 */
    ...
    //v1.2:(added l)
    WeatherDataPoint(String c, String d, byte[] p,long l) {
        city = c;
        degrees = d;
        photo=p;
        lookUpKey=l;
 ...
 */
public class BookmarkDataProvider extends ContentProvider {
	//v. 1.9:
	Hashtable<String, String> sDataNoMultipleURLs=new Hashtable<String, String>();
	
    public static final Uri CONTENT_URI =
        Uri.parse("content://gr.jvlach.bookmarkswidget.provider");
    ...
    public synchronized Cursor query(Uri uri, String[] projection, String selection,
		...
		String fileName="sData4x2"+mAppWidgetId;
